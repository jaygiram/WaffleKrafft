            ...
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <div class="contact-form bg-light rounded p-5">
                        <div id="success"></div>
                        <form name="sentMessage" action="contactdata"  id="contactForm" novalidate="novalidate" method="post">
                            <div class="form-row">
                            ...
                            <div class="control-group">
                                <input type="text"  name="address"class="form-control p-4" id="address" placeholder="Your Address" required="required" data-validation-required-message="Please enter a Your Address" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                            ...
                            <div>
                                <button class="btn btn-primary btn-block py-3 px-5" type="submit" id="sendMessageButton" value="contactpage">Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
